...
const validatePin = (pin) => {
  ...
  if (strPin.match(/[0-9]{4}/) !== null && strPin.length === 4) {
    return true;
  } else {
    return false;
  }
...
const validateWord = (word) => {
  ...
  if (strWord.match(/[a-z]{5}/i) !== null && strWord.length >= 5 && strWord.length <= 10) {
    return true;
  } else {
    return false;
  }
...
const hasNumber = (string) => {
  let wordAndNum = string.toString();
  if (wordAndNum.match(/[a-z][0-9]/i) !== null) {
    return true;
  } else {
    return false;
  }
...
const validateEmail = (email) => {
  ...
  if (strEmail.match(/^[a-z]*.[a-z]+@[a-z]*.com$/) !== null || strEmail.match(/^[a-z]*.[a-z]+@[a-z]*.net$/) !== null || strEmail.match(/^[a-z]*.[a-z]+@[a-z]*.org$/) !== null) {
    return true;
  } else {
    return false;
  }
...
const validatePhoneNumber = (phoneNumber) => {
  if (phoneNumber.match(/^(\(\d{3}\)|\d{3})(-|\s)?\d{3}(-|\s)?\d{4}$/m) !== null) {
    return true;
  } else {
    return false;
  }
