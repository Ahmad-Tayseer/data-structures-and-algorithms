...
const { map, is } = require("cheerio/lib/api/traversing");
...
const charCode = (arr) => {
  let array = arr.map(element => element.charCodeAt());
  return array;
  // Solution code here...
};
...
const evenOdd = (arr) => {
  let array = arr.map(element => numIndicator(element));
  return array;
  // Solution code here...
};
...
const abilitiesName = (ability) => {
  return ability['name'];
}

const extractAbilities = (arr) => {
  let array = arr.map(element => abilitiesName(element['ability']));
  return array;
  // Solution code here...
};
...
const extractStats = (arr) => {
  let array = arr.map(element => newObject(statsData(element['stat']), totalSum(element)));
  return array;
  // Solution code here...
};
